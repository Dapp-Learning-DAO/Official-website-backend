...
public class TeamController {
     ...
     */
    @PutMapping
    BaseResponse add(@RequestBody TeamVO team) {
     ...
     */
    @PutMapping("/join")
    BaseResponse join(@RequestBody TeamMemberJoinVO teamMember) {
     ...
     */
    @PostMapping("/exit")
    BaseResponse exit(@RequestBody TeamMemberJoinVO teamMember) {
     ...
     */
    @PostMapping("/approve")
    BaseResponse approve(@RequestBody TeamMemberApproveVO teamMemberApproveVO) {
     ...
     */
    @GetMapping("/all")
    BaseResponse getTeams(@RequestBody TeamQueryVo teamQueryVo) {
    ...
    BaseResponse getNeedApproveMembers(Long teamId) {
