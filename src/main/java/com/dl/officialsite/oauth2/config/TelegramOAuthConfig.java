...
@Service
@Slf4j
public class TelegramOAuthConfig extends BaseOAuth implements Refreshable {
    ...
    public void startUpOrRefresh() {
        this.oAuthConfig = serverConfigCacheService.get(ConfigEnum.TELEGRAM_OAUTH_CONFIG, OAuthConfig.class);
        log.info("Set up {} OAuth config {} ....", ConfigEnum.TELEGRAM_OAUTH_CONFIG.getConfigName(), this.getOAuthConfig());
    }
}