...
@Service
@Slf4j
public class GitHubOAuthConfig extends BaseOAuth implements Refreshable {
    ...
    public void startUpOrRefresh() {
        this.oAuthConfig = serverConfigCacheService.get(ConfigEnum.GITHUB_OAUTH_CONFIG, OAuthConfig.class);
        log.info("Set up {} OAuth config {} ....", ConfigEnum.GITHUB_OAUTH_CONFIG.getConfigName(), this.getOAuthConfig());
    }
}