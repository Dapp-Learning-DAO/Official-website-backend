...
public class Constant {
    ...
    public static final List<TokenConfig> POLYGON_TOKEN_LIST =Arrays.asList(POLYGON_DAI,POLYGON_USDC,POLYGON_USDT,POLYGON_WETH,POLYGON_WBTC);
    ...
    public static final List<TokenConfig> OP_TOKEN_LIST =Arrays.asList(OP_DAI,OP_USDC,OP_USDT,OP_WETH,OP_WBTC);
